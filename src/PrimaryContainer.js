    ...
    return (
        <div className="overflow-x-auto">
            <Tabs aria-label="Full width tabs" style="fullWidth">
                <Tabs.Item active title="CAMPUS" icon={MdDashboard}>
                    <VerticalTabs></VerticalTabs>
                </Tabs.Item>
                <Tabs.Item title="PERSONNEL" icon={HiUserCircle}>
                    <VerticalTabs></VerticalTabs>
                </Tabs.Item>
                <Tabs.Item title="TIME TABLE" icon={LuTimer}>
                    <VerticalTabs></VerticalTabs>
                </Tabs.Item>
            </Tabs>
            ...
            <div
                ...
                <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                    ...
                    <button type="button"
                        ...
                        <span
                            className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Wallet</span>
                    </button>
                    <button type="button"
                            className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        <svg
